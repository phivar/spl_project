...
public class SPLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"COMMENT", "KW_TRUE", "KW_FALSE", "KW_VAR", "KW_PRINT", "KW_IF", "KW_ELSE", 
			"KW_WHILE", "KW_RETURN", "KW_FUNC", "KW_NUMBER", "KW_BOOL", "KW_STRING", 
			"KW_ANY", "KW_LIST", "MUL", "DIV", "ADD", "SUB", "NEQ", "GTE", "LTE", 
			"GT", "LT", "EQ", "NOT", "AND", "OR", "ASSIGN", "LPAREN", "RPAREN", "LCURLY", 
			"RCURLY", "LSQUARE", "RSQUARE", "SEMICOLON", "COLON", "COMMA", "STRING", 
