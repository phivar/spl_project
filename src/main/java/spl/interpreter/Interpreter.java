...
public class Interpreter {
    ...
    // Runs the passed code in the interpreters scope,
    // Only used for testing, since error messages will be screwed up;
    // If an error occurs in previously executed that is not in the this.code anymore, the message will be weird.
    public void unsafeRun(String code){
        this.code = code;
        runVerbose();
    }
}
